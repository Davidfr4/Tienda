        ...
        <header class="py-6" style="background-color: orange;">
            ...
            <div class="container mx-auto flex justify-between items-center px-6">
                ...
                <div class="d-flex d-lg-none">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="menu" style="background-color: orange;">
                        <li><a href="/" class="btn menuGeneral text-white text-lg text-gray-100 no-underline px-5">Inicio</a></li>
                        <li><a href="{{ route('productos.index') }}" class="btn menuGeneral text-white text-lg text-gray-100 no-underline px-5 py-2">{{ __("Todos los productos") }}</a></li>
                        <li><a href="{{ route('productos.indexComponentes') }}" class="btn menuGeneral text-white text-lg text-gray-100 no-underline px-5 py-2">{{ __("Componentes de ordenador") }}</a></li>
                        <li><a href="{{ route('productos.indexElectronica') }}" class="btn menuGeneral text-white text-lg text-gray-100 no-underline px-5 py-2">{{ __("Productos de electrónica") }}</a></li>
                        <li><a href="{{ route('productos.indexElectrodomesticos') }}" class="btn menuGeneral text-white text-lg text-gray-100 no-underline px-5 py-2">{{ __("Electrodomésticos") }}</a></li>
                ...
                <div class="d-none d-lg-block">
                    ...
                    Productos
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1" style="background-color: orange;">
                            ...
                            <li><a href="{{ route('productos.index') }}" class="text-lg font-semibold no-underline px-3 text-white py-2">{{ __("Todos los productos") }}</a></li>
                            <li><a href="{{ route('productos.indexComponentes') }}" class="text-lg font-semibold no-underline px-3 text-white py-2">{{ __("Componentes de ordenador") }}</a></li>
                            <li><a href="{{ route('productos.indexElectronica') }}" class="text-lg font-semibold no-underline px-3 text-white py-2">{{ __("Productos de electrónica") }}</a></li>
                            <li><a href="{{ route('productos.indexElectrodomesticos') }}" class="text-lg font-semibold no-underline px-3 text-white py-2">{{ __("Electrodomésticos") }}</a></li>
